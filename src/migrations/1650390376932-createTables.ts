...
export class createTables1650390376932 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "residents" ("residentId" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "cpf" character varying(14) NOT NULL, "apartmentBlock" character varying, "apartmentNumber" integer, "isAuth" boolean NOT NULL DEFAULT false, "condominiumCondominiumId" uuid, CONSTRAINT "UQ_674b467498da891ecc3bfeb9344" UNIQUE ("email"), CONSTRAINT "UQ_7d620dede9e09f8d58c77b51943" UNIQUE ("cpf"), CONSTRAINT "PK_36f852c7307ae0c2991a749c0f7" PRIMARY KEY ("residentId"))`,
        );
        await queryRunner.query(
            `CREATE TABLE "services" ("serviceId" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" text NOT NULL, "status" character varying NOT NULL DEFAULT 'available', "residentResidentId" uuid NOT NULL, "categoryCategoryId" uuid NOT NULL, "serviceProviderServiceProviderId" uuid, CONSTRAINT "PK_bd9b50de0bd3040ab0debaf36f5" PRIMARY KEY ("serviceId"))`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "condominiums_service_providers" ADD CONSTRAINT "FK_c63b66fac5630e18c16ad0c7887" FOREIGN KEY ("condominiumCondominiumId") REFERENCES "condominiums"("condominiumId") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "condominiums_service_providers" ADD CONSTRAINT "FK_7e6b15e1834d12be2cbd52f13c5" FOREIGN KEY ("serviceProviderServiceProviderId") REFERENCES "service_providers"("serviceProviderId") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "residents" ADD CONSTRAINT "FK_28abd03a0bb8f965adef9506afc" FOREIGN KEY ("condominiumCondominiumId") REFERENCES "condominiums"("condominiumId") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "services" ADD CONSTRAINT "FK_5172978348f162a69a010123f34" FOREIGN KEY ("residentResidentId") REFERENCES "residents"("residentId") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "services" ADD CONSTRAINT "FK_a03d8f4612a66c4381d89493650" FOREIGN KEY ("categoryCategoryId") REFERENCES "categories"("categoryId") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
            `ALTER TABLE "services" ADD CONSTRAINT "FK_aa6884a1043c3651f1d56c3a64a" FOREIGN KEY ("serviceProviderServiceProviderId") REFERENCES "service_providers"("serviceProviderId") ON DELETE SET NULL ON UPDATE NO ACTION`,
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `INSERT INTO "categories" ("name") VALUES ('Aulas Particulares'), ('Eventos'), ('Manutenção Residencial'), ('Saúde e Bem-Estar'), ('Beleza'), ('Assistência Técnica'), ('Limpeza'), ('Consultoria'), ('Pets'), ('Astrologia'), ('Outros') `,
        );
    }
